...
//========================================================================
// ■ State_Loitering_Entity
//------------------------------------------------------------------------
//	実体の徘徊状態クラス。
//========================================================================

public class State_Loitering_Entity : State_Base_Entity {
	//--------------------------------------------------------------------
	// ● 定数
	//--------------------------------------------------------------------
	enum State {
	...
	protected State_Base_Entity next_state;
	Vector3 last_position;
	float stop_second;
	//--------------------------------------------------------------------
	// ● コンストラクタ
	//--------------------------------------------------------------------
	public State_Loitering_Entity(State_Base_Entity next_state = null) {
...
//		Debug_EX.add("" + stop_second);
	...
	void update_loitering() {
		...
		if (delta.magnitude < 1 ||
			ai.points.points[index].y < ai.sea.position.y + 1)
		{
